...
As described in section \@ref(rf), the feature importance was calculated using permuting feature importance of the _randomForest_ R package. In this analysis, feature importance is derived from the percentage increase of the mean squared error (MSE) of the overall random forest regression model in regard to the response variable `price_eur`. When the percentage increase of the MSE is higher, the feature is more important. Accordingly, when the percentage increase of the MSE is lower, the feature is less important.

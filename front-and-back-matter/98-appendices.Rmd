...
```{r relationship-x-y, echo = FALSE, warning = FALSE, message = FALSE, results = 'hide', fig.cap="A Plot Showing the Relationship between Independent Variables and Price", out.width="100%"}
tidy_ikea %>%
...
```{r coplot-code, warning = FALSE, message = FALSE, eval = FALSE, fig.cap="Code for Coplotting Combinations", out.width="100%"}

...
Lastly, the authors were surprised by the high feature importances of the variables `designer` and `name` computed by the random forest model. Both designer and name have lots different values, suggesting an overfitting of the random forest model. This, however, is objected by scientific research [@Breiman2001, p.29].

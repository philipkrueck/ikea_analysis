...
The `designer` variable is the second most important feature. It might seem, that this is due to *overfitting*, since the random forest regression model takes into account around 50 different combinations of designers, partly with a low number of occurences. But according to @Breiman2001[p.29] random forest models are robust against overfitting. Further research should be conducted to analyze whether overfitting is present or not.
